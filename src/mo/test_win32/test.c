#include <stdio.h>
// Regenerate test.pot:
//   xgettext --add-comments="trans:" --from-code=UTF-8 --package-name=TestSoftware --package-version=v0.0.0 --add-location=file --copyright-holder="TestSoftware Developers" --no-wrap --sort-output --output test.pot test.c
// Create intial *.po:
